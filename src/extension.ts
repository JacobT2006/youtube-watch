...
class YouTubeViewProvider implements vscode.WebviewViewProvider {
    ...
    private _getHtmlForWebview(webview: vscode.Webview): string {
        // Embed YouTube with guest access
        return `
            <!DOCTYPE html>
            <html lang="en">
            <head>
            ...
            <body>
                <iframe src="https://www.youtube.com/embed/videoseries?list=PL" sandbox="allow-scripts allow-forms allow-same-origin allow-popups"></iframe>
            </body>
            </html>
        `;
    }
